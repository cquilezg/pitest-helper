...
@Tag("maven")
@Tag("java")
class JavaMavenRunMutationCoverageActionUiNewTest {

    @IDEInstance(testName = "javaMavenUiTest", projectPath = PROJECT_NAME)
    ...
    inner class SingleNodeSelectionTest {
        ...
        @MethodSource("com.cquilez.pitesthelper.ui.actions.maven.JavaMavenRunMutationCoverageActionUiNewTest#singleNodeTestCases")
    ...
    inner class MultiNodeSelectionTest {
        ...
        @ParameterizedTest(name = "{0}")
        @MethodSource("com.cquilez.pitesthelper.ui.actions.maven.JavaMavenRunMutationCoverageActionUiNewTest#multiNodeTestCases")
