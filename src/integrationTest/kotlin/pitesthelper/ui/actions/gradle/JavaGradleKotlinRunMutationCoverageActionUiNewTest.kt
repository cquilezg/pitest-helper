...
@Tag("gradle")
@Tag("java")
class JavaGradleKotlinRunMutationCoverageActionUiNewTest {

    @IDEInstance(testName = "javaGradleKotlinUiTest", projectPath = PROJECT_NAME)
    private lateinit var run: BackgroundRun

    companion object {
        private const val PROJECT_NAME = "sample-gradle-kotlin"
    ...
    inner class SingleNodeSelectionTest {
        ...
        @MethodSource("com.cquilez.pitesthelper.ui.actions.gradle.JavaGradleKotlinRunMutationCoverageActionUiNewTest#singleNodeTestCases")
    ...
    inner class MultiNodeSelectionTest {
        ...
        @ParameterizedTest(name = "{0}")
        @MethodSource("com.cquilez.pitesthelper.ui.actions.gradle.JavaGradleKotlinRunMutationCoverageActionUiNewTest#multiNodeTestCases")
